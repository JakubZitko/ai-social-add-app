...
export default function TikTokAdPage() {
  return (
    <ProtectedRoute>
      <AppLayout>
        <TikTokAdContent />
...
function TikTokAdContent() {
  ...
  const template = VIDEO_TEMPLATES.find((t) => t.id === 'tiktok-native-ad')!;
  ...
  const generateScript = () => {
    ...
    const script = template.scriptTemplate
      ...
      .replace('{testimonial}', testimonial || 'Amazing results!')
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/generate/tiktok-ad', {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 mb-8">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="e.g., Over 10,000 happy customers!"
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900"
            />
          </div>
          ...
          <div className="mb-6">
            ...
            {useCustomScript ? (
              <textarea
                ...
                rows={8}
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 font-mono text-sm"
              />
            ) : (
          ...
          >
            {generating ? (
              ...
              <>
                ...
                Generate TikTok Ad ({template.price || 2} credits)
