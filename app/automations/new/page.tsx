...
function NewAutomationContent() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success('Automation Created!', 'Your automation is now active');
      router.push('/automations');
    } catch (err: any) {
      console.error('Error creating automation:', err);
      toast.error('Failed to create', err.message || 'Please try again');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="bg-white h-full rounded-[40px] shadow-sm border border-gray-200/60 overflow-y-auto">
        ...
        <div className="p-8 max-w-3xl mx-auto">
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Add Actions</h2>
